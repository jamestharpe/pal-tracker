...
public class TimeEntryControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        doReturn(mock(Counter.class)).when(mockMeterRegistry).counter(any(String.class));
        doReturn(mock(DistributionSummary.class)).when(mockMeterRegistry).summary(any(String.class));
